...
?>
<h1 class="admin-header">Consultas y Mensajes <?= $unread ? '<span class="badge">' . $unread . ' sin leer</span>' : '' ?></h1>
...
<div class="card-admin">
    ...
    <div class="msg-card <?= $m['leido'] ? '' : 'unread' ?>">
        ...
        <div style="margin-top:.6rem; display:flex; gap:.5rem">
            <?php if (!$m['leido']): ?><a class="btn-mark" href="mensajes.php?leido=<?= (int)$m['id'] ?>">Marcar leído</a><?php endif; ?>
            <a class="btn-mark" href="mensajes.php?delete=<?= (int)$m['id'] ?>" onclick="return confirm('¿Eliminar consulta?')">Eliminar</a>
